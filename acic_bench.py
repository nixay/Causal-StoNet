...
def main():
    ...
    cf = pd.read_csv('./raw_data/acic_bench/highDim_testdataset1_cf.csv')
    true_cate = cf['EY1'] - cf['EY0']
    ...
    for prune_seed in range(num_seed):
        ...
        print("Train 1")
        output_train1 = training(mode="train", net=net, epochs=training_epochs, optimizer_list=optimizer_list_train,
                                 impute_lrs=impute_lrs, **optim_args)
