...
from data import BRCA, data_preprocess
...
parser.add_argument('--treat_node', default=1, type=int, nargs='+', help='the position of the treatment variable')
parser.add_argument('--treat_loss_weight', default=200, type=float, help='multiplier to scale the treatment loss')
